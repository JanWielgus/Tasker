...
#define SLEEPING_FUNCTION                       // comment this line if you don't want to use sleeping function

#define PROCESSOR_OVERLOAD_CALLBACK             // comment this line if you don't want to use processor overload callback 
